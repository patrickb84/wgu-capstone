						...
						<Col lg={4}>
							<Card className="border-0">
								...
								<Card.Body>
									...
									<Card.Text>Plan your meals for the week and get a shopping list for the weekend.</Card.Text>
								</Card.Body>
							</Card>
						</Col>
						<Col lg={4}>
							<Card className="border-0">
								...
								<Card.Body>
									...
									<Card.Text>
										Find recipes based on your preferences and ingredients you have at home.
									</Card.Text>
								</Card.Body>
							</Card>
						</Col>
						<Col lg={4}>
							<Card className="border-0">
								...
								<Card.Body>
									...
									<Card.Text>Save your favorite recipes and plan them for the week.</Card.Text>
								</Card.Body>
							</Card>
						</Col>
					</Row>
			...
			<Container>
				{!user ? (
					...
					<div
						className="text-center d-flex align-items-center justify-content-center flex-column pt-3"
						style={{ height: '30rem' }}>
						<h1 className="font-display text-white display-1">Get Started!</h1>
						<div className="pt-4">
							<Link to={ROUTES.MEAL_PLANS} className="btn btn-light btn-lg px-5 mx-1 mx-lg-2" replace>
								Create a Meal Plan
							</Link>
							<Link replace to={ROUTES.RECIPES} className="mx-1 mx-lg-2 btn btn-secondary btn-lg px-5">
								View Recipes
							</Link>
						</div>
					</div>
